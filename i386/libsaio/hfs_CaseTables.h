 ...
 *
 * Updates:
 *			- Table data updated to match the XNU 2050.18.24 source code (PikerAlpha, November 2012)
 *			- Latin is now a seperate table, done to make it faster (PikerAlpha, November 2012)
 *			- Compressed and uncompressed table data is now 100% the same (PikerAlpha, November 2012)
 ...
 *			- Table length errors fixed. Don't use 512/5632 instead of 256/2816 (PikerAlpha, November 2012)
 *			- Table data verified against HFSPlusX64.efi (PikerAlpha, November 2012)
 *
 */


/*
 * The default setting is 1, but you can change it to 0 to use uncompressed
 * table data. Making the booter 5152 bytes (data/extra code) bigger.
 */

#define USE_COMPRESSED_TABLES	1

/* Do NOT change this one! */

#define USE_UNCOMPRESSED_TABLES ! USE_COMPRESSED_TABLES


#if USE_UNCOMPRESSED_TABLES
/*==============================================================================
...
u_int16_t gLatinCaseFoldTable[] =
{
	// gLatinCaseFold in XNU/bsd/hfs/hfscommon/Unicode/UCStringCompareData.h) 512 bytes starting @ 0x4240 in HFSPlusX64.efi
...
{
	/* Table 0 high-byte indices ( == 0 iff no case mapping and no ignorables ) 512 bytes starting @ 0x4440 in HFSPlusX64.efi */
	...
	// Table 1 (for high byte 0x01) 512 bytes starting @ 0x4640 in HFSPlusX64.efi
	...
	// Table 2 (for high byte 0x03) 512 bytes starting @ 0x4840 in HFSPlusX64.efi
	...
	// Table 3 (for high byte 0x04) 512 bytes starting @ 0x4A40 in HFSPlusX64.efi
	...
	// Table 4 (for high byte 0x05) 512 bytes starting @ 0x4C40 in HFSPlusX64.efi
	...
	// Table 5 (for high byte 0x10) 512 bytes starting @ 0x4E40 in HFSPlusX64.efi
	...
	// Table 6 (for high byte 0x20) 512 bytes starting @ 0x5040 in HFSPlusX64.efi
	...
	// Table 7 (for high byte 0x21) 512 bytes starting @ 0x5240 in HFSPlusX64.efi
	...
	// Table 8 (for high byte 0xFE) 512 bytes starting @ 0x5440 in HFSPlusX64.efi
	...
	// Table 9 (for high byte 0xFF) 512 bytes starting @ 0x5640 in HFSPlusX64.efi
...
unsigned short *gLatinCaseFoldTable;
unsigned short *gLowerCaseTable;
unsigned short *gCompareTable;

struct CompressedBlock gLatinCaseFoldTableCompressed[] =
{
	{ kTypeLiteral,		0x01, 0xffff },
	{ kTypeAscending,	0x40, 0x0001 },
	{ kTypeAscending,	0x1a, 0x0061 },
	{ kTypeAscending,	0x6b, 0x005b },
	{ kTypeLiteral,		0x01, 0x00e6 },
	{ kTypeAscending,	0x09, 0x00c7 },
	{ kTypeLiteral,		0x01, 0x00f0 },
	{ kTypeAscending,	0x07, 0x00d1 },
	{ kTypeLiteral,		0x01, 0x00f8 },
	{ kTypeAscending,	0x05, 0x00d9 },
	{ kTypeLiteral,		0x01, 0x00fe },
	{ kTypeAscending,	0x21, 0x00df }
};

struct CompressedBlock gLowerCaseTableCompressed[] =
{
	/* Table 0 */
	{ kTypeLiteral,		0x01, 0x0000 },
	{ kTypeLiteral,		0x01, 0x0100 },
	{ kTypeLiteral,		0x01, 0x0000 },
	{ kTypeLiteral,		0x01, 0x0200 },
	{ kTypeLiteral,		0x01, 0x0300 },
	{ kTypeLiteral,		0x01, 0x0400 },
	{ kTypeLiteral,		0x0a, 0x0000 },
	{ kTypeLiteral,		0x01, 0x0500 },
	{ kTypeLiteral,		0x0f, 0x0000 },
	{ kTypeLiteral,		0x01, 0x0600 },
	{ kTypeLiteral,		0x01, 0x0700 },
	{ kTypeLiteral,		0xdc, 0x0000 },
	{ kTypeLiteral,		0x01, 0x0800 },
	{ kTypeLiteral,		0x01, 0x0900 },

	/* Table 1 */
	{ kTypeAscending,	0x10, 0x0100 },
	{ kTypeLiteral,		0x01, 0x0111 },
	{ kTypeAscending,	0x15, 0x0111 },
	{ kTypeLiteral,		0x01, 0x0127 },
	{ kTypeAscending,	0x0b, 0x0127 },
	{ kTypeLiteral,		0x01, 0x0133 },
	{ kTypeAscending,	0x0c, 0x0133 },
	{ kTypeLiteral,		0x02, 0x0140 },
	{ kTypeLiteral,		0x01, 0x0142 },
	{ kTypeAscending,	0x08, 0x0142 },
	{ kTypeLiteral,		0x01, 0x014b },
	{ kTypeAscending,	0x07, 0x014b },
	{ kTypeLiteral,		0x01, 0x0153 },
	{ kTypeAscending,	0x13, 0x0153 },
	{ kTypeLiteral,		0x01, 0x0167 },
	{ kTypeAscending,	0x1a, 0x0167 },
	{ kTypeLiteral,		0x01, 0x0253 },
	{ kTypeLiteral,		0x02, 0x0183 },
	{ kTypeLiteral,		0x02, 0x0185 },
	{ kTypeLiteral,		0x01, 0x0254 },
	{ kTypeLiteral,		0x02, 0x0188 },
	{ kTypeAscending,	0x02, 0x0256 },
	{ kTypeLiteral,		0x01, 0x018c },
	{ kTypeAscending,	0x02, 0x018c },
	{ kTypeLiteral,		0x01, 0x01dd },
	{ kTypeLiteral,		0x01, 0x0259 },
	{ kTypeLiteral,		0x01, 0x025b },
	{ kTypeLiteral,		0x02, 0x0192 },
	{ kTypeLiteral,		0x01, 0x0260 },
	{ kTypeLiteral,		0x01, 0x0263 },
	{ kTypeLiteral,		0x01, 0x0195 },
	{ kTypeLiteral,		0x01, 0x0269 },
	{ kTypeLiteral,		0x01, 0x0268 },
	{ kTypeLiteral,		0x01, 0x0199 },
	{ kTypeAscending,	0x03, 0x0199 },
	{ kTypeLiteral,		0x01, 0x026f },
	{ kTypeLiteral,		0x01, 0x0272 },
	{ kTypeLiteral,		0x01, 0x019e },
	{ kTypeLiteral,		0x01, 0x0275 },
	{ kTypeAscending,	0x02, 0x01a0 },
	{ kTypeLiteral,		0x02, 0x01a3 },
	{ kTypeLiteral,		0x02, 0x01a5 },
	{ kTypeLiteral,		0x01, 0x01a6 },
	{ kTypeLiteral,		0x02, 0x01a8 },
	{ kTypeLiteral,		0x01, 0x0283 },
	{ kTypeAscending,	0x02, 0x01aa },
	{ kTypeLiteral,		0x02, 0x01ad },
	{ kTypeLiteral,		0x01, 0x0288 },
	{ kTypeAscending,	0x02, 0x01af },
	{ kTypeAscending,	0x02, 0x028a },
	{ kTypeLiteral,		0x02, 0x01b4 },
	{ kTypeLiteral,		0x02, 0x01b6 },
	{ kTypeLiteral,		0x01, 0x0292 },
	{ kTypeLiteral,		0x02, 0x01b9 },
	{ kTypeAscending,	0x02, 0x01ba },
	{ kTypeLiteral,		0x01, 0x01bd },
	{ kTypeAscending,	0x07, 0x01bd },
	{ kTypeLiteral,		0x03, 0x01c6 },
	{ kTypeLiteral,		0x03, 0x01c9 },
	{ kTypeLiteral,		0x02, 0x01cc },
	{ kTypeAscending,	0x18, 0x01cc },
	{ kTypeLiteral,		0x01, 0x01e5 },
	{ kTypeAscending,	0x0c, 0x01e5 },
	{ kTypeLiteral,		0x02, 0x01f3 },
	{ kTypeAscending,	0x0d, 0x01f3 },

	/* Table 2 */
	{ kTypeAscending,	0x91, 0x0300 },
	{ kTypeAscending,	0x11, 0x03b1 },
	{ kTypeLiteral,		0x01, 0x03a2 },
	{ kTypeAscending,	0x07, 0x03c3 },
	{ kTypeAscending,	0x38, 0x03aa },
	{ kTypeLiteral,		0x02, 0x03e3 },
	{ kTypeLiteral,		0x02, 0x03e5 },
	{ kTypeLiteral,		0x02, 0x03e7 },
	{ kTypeLiteral,		0x02, 0x03e9 },
	{ kTypeLiteral,		0x02, 0x03eb },
	{ kTypeLiteral,		0x02, 0x03ed },
	{ kTypeLiteral,		0x02, 0x03ef },
	{ kTypeAscending,	0x10, 0x03f0 },

	/* Table 3 */
	{ kTypeAscending,	0x02, 0x0400 },
	{ kTypeLiteral,		0x01, 0x0452 },
	{ kTypeLiteral,		0x01, 0x0403 },
	{ kTypeAscending,	0x03, 0x0454 },
	{ kTypeLiteral,		0x01, 0x0407 },
	{ kTypeAscending,	0x04, 0x0458 },
	{ kTypeAscending,	0x03, 0x040c },
	{ kTypeLiteral,		0x01, 0x045f },
	{ kTypeAscending,	0x09, 0x0430 },
	{ kTypeLiteral,		0x01, 0x0419 },
	{ kTypeAscending,	0x16, 0x043a },
	{ kTypeAscending,	0x30, 0x0430 },
	{ kTypeLiteral,		0x02, 0x0461 },
	{ kTypeLiteral,		0x02, 0x0463 },
	{ kTypeLiteral,		0x02, 0x0465 },
	{ kTypeLiteral,		0x02, 0x0467 },
	{ kTypeLiteral,		0x02, 0x0469 },
	{ kTypeLiteral,		0x02, 0x046b },
	{ kTypeLiteral,		0x02, 0x046d },
	{ kTypeLiteral,		0x02, 0x046f },
	{ kTypeLiteral,		0x02, 0x0471 },
	{ kTypeLiteral,		0x02, 0x0473 },
	{ kTypeLiteral,		0x02, 0x0475 },
	{ kTypeAscending,	0x02, 0x0476 },
	{ kTypeLiteral,		0x02, 0x0479 },
	{ kTypeLiteral,		0x02, 0x047b },
	{ kTypeLiteral,		0x02, 0x047d },
	{ kTypeLiteral,		0x02, 0x047f },
	{ kTypeLiteral,		0x02, 0x0481 },
	{ kTypeAscending,	0x0e, 0x0482 },
	{ kTypeLiteral,		0x02, 0x0491 },
	{ kTypeLiteral,		0x02, 0x0493 },
	{ kTypeLiteral,		0x02, 0x0495 },
	{ kTypeLiteral,		0x02, 0x0497 },
	{ kTypeLiteral,		0x02, 0x0499 },
	{ kTypeLiteral,		0x02, 0x049b },
	{ kTypeLiteral,		0x02, 0x049d },
	{ kTypeLiteral,		0x02, 0x049f },
	{ kTypeLiteral,		0x02, 0x04a1 },
	{ kTypeLiteral,		0x02, 0x04a3 },
	{ kTypeLiteral,		0x02, 0x04a5 },
	{ kTypeLiteral,		0x02, 0x04a7 },
	{ kTypeLiteral,		0x02, 0x04a9 },
	{ kTypeLiteral,		0x02, 0x04ab },
	{ kTypeLiteral,		0x02, 0x04ad },
	{ kTypeLiteral,		0x02, 0x04af },
	{ kTypeLiteral,		0x02, 0x04b1 },
	{ kTypeLiteral,		0x02, 0x04b3 },
	{ kTypeLiteral,		0x02, 0x04b5 },
	{ kTypeLiteral,		0x02, 0x04b7 },
	{ kTypeLiteral,		0x02, 0x04b9 },
	{ kTypeLiteral,		0x02, 0x04bb },
	{ kTypeLiteral,		0x02, 0x04bd },
	{ kTypeLiteral,		0x02, 0x04bf },
	{ kTypeAscending,	0x03, 0x04c0 },
	{ kTypeLiteral,		0x02, 0x04c4 },
	{ kTypeAscending,	0x02, 0x04c5 },
	{ kTypeLiteral,		0x02, 0x04c8 },
	{ kTypeAscending,	0x02, 0x04c9 },
	{ kTypeLiteral,		0x01, 0x04cc },
	{ kTypeAscending,	0x34, 0x04cc },

	/* Table 4 */	
	{ kTypeAscending,	0x31, 0x0500 },
	{ kTypeAscending,	0x26, 0x0561 },
	{ kTypeAscending,	0xa9, 0x0557 },

	/* Table 5 */
	{ kTypeAscending,	0xa0, 0x1000 },
	{ kTypeAscending,	0x26, 0x10d0 },
	{ kTypeAscending,	0x3a, 0x10c6 },

	/* Table 6 */
	{ kTypeAscending,	0x0c, 0x2000 },
	{ kTypeLiteral,		0x04, 0x0000 },
	{ kTypeAscending,	0x1a, 0x2010 },
	{ kTypeLiteral,		0x05, 0x0000 },
	{ kTypeAscending,	0x3b, 0x202f },
	{ kTypeLiteral,		0x06, 0x0000 },
	{ kTypeAscending,	0x90, 0x2070 },

	/* Table 7 */
	{ kTypeLiteral,		0x01, 0x2100 },
	{ kTypeAscending,	0x5f, 0x2101 },
	{ kTypeAscending,	0x10, 0x2170 },
	{ kTypeAscending,	0x90, 0x2170 },

	/* Table 8 */
	{ kTypeAscending,	0xff, 0xfe00 },
	{ kTypeLiteral,		0x01, 0x0000 },

	/* Table 9 */
	{ kTypeAscending,	0x21, 0xff00 },
	{ kTypeAscending,	0x1a, 0xff41 },
	{ kTypeAscending,	0xc5, 0xff3b }
};


struct CompressedBlock gCompareTableCompressed[] =
{
	{ kTypeAscending256,	0x60, 0x0000 },
	{ kTypeLiteral,			0x01, 0x4180 },
	{ kTypeAscending256,	0x1a, 0x4100 },
	{ kTypeAscending256,	0x05, 0x7b00 },
	{ kTypeLiteral,			0x01, 0x4108 },
	{ kTypeLiteral,			0x01, 0x410c },
	{ kTypeLiteral,			0x01, 0x4310 },
	{ kTypeLiteral,			0x01, 0x4502 },
	{ kTypeLiteral,			0x01, 0x4e0a },
	{ kTypeLiteral,			0x01, 0x4f08 },
	{ kTypeLiteral,			0x01, 0x5508 },
	{ kTypeLiteral,			0x01, 0x4182 },
	{ kTypeLiteral,			0x01, 0x4104 },
	{ kTypeLiteral,			0x01, 0x4186 },
	{ kTypeLiteral,			0x01, 0x4108 },
	{ kTypeLiteral,			0x01, 0x410a },
	{ kTypeLiteral,			0x01, 0x410c },
	{ kTypeLiteral,			0x01, 0x4310 },
	{ kTypeLiteral,			0x01, 0x4502 },
	{ kTypeLiteral,			0x01, 0x4584 },
	{ kTypeLiteral,			0x01, 0x4586 },
	{ kTypeLiteral,			0x01, 0x4588 },
	{ kTypeLiteral,			0x01, 0x4982 },
	{ kTypeLiteral,			0x01, 0x4984 },
	{ kTypeLiteral,			0x01, 0x4986 },
	{ kTypeLiteral,			0x01, 0x4988 },
	{ kTypeLiteral,			0x01, 0x4e0a },
	{ kTypeLiteral,			0x01, 0x4f82 },
	{ kTypeLiteral,			0x01, 0x4f84 },
	{ kTypeLiteral,			0x01, 0x4f86 },
	{ kTypeLiteral,			0x01, 0x4f08 },
	{ kTypeLiteral,			0x01, 0x4f0a },
	{ kTypeLiteral,			0x01, 0x5582 },
	{ kTypeLiteral,			0x01, 0x5584 },
	{ kTypeLiteral,			0x01, 0x5586 },
	{ kTypeLiteral,			0x01, 0x5508 },
	{ kTypeAscending256,	0x07, 0xa000 },
	{ kTypeLiteral,			0x01, 0x5382 },
	{ kTypeAscending256,	0x06, 0xa800 },
	{ kTypeLiteral,			0x01, 0x4114 },
	{ kTypeLiteral,			0x01, 0x4f0e },
	{ kTypeAscending256,	0x0b, 0xb000 },
	{ kTypeLiteral,			0x01, 0x4192 },
	{ kTypeLiteral,			0x01, 0x4f92 },
	{ kTypeLiteral,			0x01, 0xbd00 },
	{ kTypeLiteral,			0x01, 0x4114 },
	{ kTypeLiteral,			0x01, 0x4f0e },
	{ kTypeAscending256,	0x07, 0xc000 },
	{ kTypeLiteral,			0x01, 0x2206 },
	{ kTypeLiteral,			0x01, 0x2208 },
	{ kTypeLiteral,			0x01, 0xc900 },
	{ kTypeLiteral,			0x01, 0x2000 },
	{ kTypeLiteral,			0x01, 0x4104 },
	{ kTypeLiteral,			0x01, 0x410a },
	{ kTypeLiteral,			0x01, 0x4f0a },
	{ kTypeLiteral,			0x02, 0x4f14 },
	{ kTypeAscending256,	0x02, 0xd000 },
	{ kTypeLiteral,			0x01, 0x2202 },
	{ kTypeLiteral,			0x01, 0x2204 },
	{ kTypeLiteral,			0x01, 0x2702 },
	{ kTypeLiteral,			0x01, 0x2704 },
	{ kTypeAscending256,	0x02, 0xd600 },
	{ kTypeLiteral,			0x01, 0x5988 },
	{ kTypeAscending256,	0x27, 0xd900 },
};


#define kLatinCaseFoldTableNBlocks	(sizeof(gLatinCaseFoldTableCompressed) / sizeof(*gLatinCaseFoldTableCompressed))
...
#define kLatinCaseFoldTableDataSize	256
#define kLowerCaseTableDataSize		2816
#define	kCompareTableDataSize		256

#endif /* USE_UNCOMPRESSED_TABLES */
