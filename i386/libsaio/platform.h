...
#define IMAC_133				(IMAC | ( 6 << 15))
#define IMAC_141				(IMAC | ( 7 << 15))
#define IMAC_142				(IMAC | ( 8 << 15))
#define IMAC_143				(IMAC | ( 9 << 15))
#define IMAC_144				(IMAC | (10 << 15))
#define IMAC_151				(IMAC | (11 << 15))
...
#define IMAC_183				(IMAC | (18 << 15))
#define IMAC_191				 IMAC						// Defaults to iMac19,1
